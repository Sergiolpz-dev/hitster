    ...
    <div className="min-h-screen bg-zinc-950 flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-sm text-center">
        ...
        <div className="mb-12">
          ...
          <h1 className="text-[100px] leading-none font-black text-white"
        ...
        <div className="mb-12 space-y-2">
          {['🎵 Escucha la canción', '🎤 Adivina artista y título', '📅 Colócala en el tiempo'].map((text, i) => (
            <p key={i} className="text-zinc-500 text-sm tracking-wide"
              style={{ fontFamily: 'system-ui' }}>
              {text}
            </p>
          ))}
        ...
        <button
          ...
          className="w-full py-5 text-xl tracking-[4px] uppercase font-black
